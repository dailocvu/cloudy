  ...
  return (
    <div className="relative pt-24 bg-white py-8 sm:py-24 ">
      <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
        <h2
          data-aos="fade-up"
          className="text-base font-semibold tracking-wider text-pink-600 uppercase"
        >
          Deploy faster
        </h2>
        <p
            ...
            {props.features.map((feature) => (
              <div key={feature.name} className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    <div>
                      <span className="inline-flex items-center justify-center p-3 bg-gradient-to-br from-pink-600 to-pink-800 rounded-md shadow-lg">
                        <feature.icon
